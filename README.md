...
Repositório dedicado às resoluções de exercícios e atividades práticas da disciplina de **Ciência de Dados I**, do curso de Engenharia de Computação do CEFET-MG (Campus Timóteo).

## 🎯 Objetivo
Construir uma base sólida em análise de dados, machine learning e manipulação de informações utilizando a stack de dados do ecossistema Python.
...
```bash
git clone [https://github.com/MateusCunha-Dev/ciencia-de-dados-1-cefet.git](https://github.com/MateusCunha-Dev/ciencia-de-dados-1-cefet.git)